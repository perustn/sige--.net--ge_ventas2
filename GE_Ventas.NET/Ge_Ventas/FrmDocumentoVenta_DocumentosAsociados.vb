...
Public Class FrmDocumentoVenta_DocumentosAsociados
    ...
    Private Sub FrmDocumentoVenta_DocumentosAsociados_Load(sender As Object, e As EventArgs) Handles MyBase.Load
